...
const Products = (category: IProducts) => {
  ...
  if (loading) {
    ...
    <svg aria-hidden="true" className="inline w-5 h-5 text-gray-200 animate-spin dark:text-gray-600 fill-teal-500" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
...
/>
                  ...
                  <h2 className="font-geist overflow-hidden text-nowrap">{item.title}</h2>
